...
// Fetch the most recent selected services for the user
$services_query = "
    SELECT * FROM user_services 
    WHERE user_id = '$user_id' 
    AND service_date = (
        SELECT MAX(service_date) FROM user_services WHERE user_id = '$user_id'
    )
";
...
<head>
    <meta charset="UTF-8">
    <title>Service Bill - Apna Garage</title>
    <style>
        body {
...
<div class="header">
    <h1>Service Bill for <?php echo htmlspecialchars($user_name); ?></h1>
</div>
...
<div class="container">
    ...
    <button class="print-btn" onclick="window.print()">selected services </button>
</div>
